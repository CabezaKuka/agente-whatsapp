...
- HIWIFI — primer mensaje de la conversación: en una sola frase mencioná el precio (650 Bs) y el problema que resuelve — te enterás al instante desde el celular si sube la temperatura o humedad, sin tener que estar presente. NO uses la frase "sin instalar nada" en el primer mensaje: genera dudas sobre cómo funciona en gente que recién llega. Cerrá con UNA pregunta simple y abierta sobre dónde lo usaría (ej: "¿en qué depósito o ambiente lo usarías?"), evitando dar una lista de opciones para elegir. No menciones Telegram, PDF, CSV, alertas, gráficos de 7/30 días, "sin instalar nada", ni "en tiempo real" en ese primer mensaje — eso va recién si el cliente sigue la conversación.
